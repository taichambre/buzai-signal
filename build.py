...
data = {
  ...
  "annotations": [
    {"start":"2018-01","end":"2018-10","title":"DRAMスーパーサイクル","note":"DRAM契約価格が高止まり。メモリのリードタイムが大幅に長期化。"},
    {"start":"2021-02","end":"2022-09","title":"コロナ後の全面的な供給逼迫","note":"銅・すず・樹脂が同時に急騰し、半導体・受動部品も逼迫。NY連銀の納期指数は過去最悪水準。コネクタ・電源・MCUのリードタイムが52週超に。"},
    {"start":"2023-04","end":"2024-03","title":"メモリ・一部部材の市況の底","note":"DRAM/NANDが記録的安値。多くの部材でリードタイムが正常化。"},
    {"start":"2024-10","end":"2026-07","title":"AI需要による再逼迫","note":"HBM優先の生産配分で汎用DRAM・DDR4が逼迫。銅・金も並行して急騰し、複数の材料区分で同時に値上げ圧力。"},
  ],
